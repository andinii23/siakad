...
//
//     final kelasKrsModel = kelasKrsModelFromJson(jsonString);

import 'dart:convert';

KelasKrsModel kelasKrsModelFromJson(String str) => KelasKrsModel.fromJson(json.decode(str));

String kelasKrsModelToJson(KelasKrsModel data) => json.encode(data.toJson());
...
class KelasKrsModel {
    ...
    factory KelasKrsModel.fromJson(Map<String, dynamic> json) => KelasKrsModel(
        code: json["code"],
