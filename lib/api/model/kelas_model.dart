...
//
//     final kelasKontrakModel = kelasKontrakModelFromJson(jsonString);

import 'dart:convert';

KelasKontrakModel kelasKontrakModelFromJson(String str) => KelasKontrakModel.fromJson(json.decode(str));

String kelasKontrakModelToJson(KelasKontrakModel data) => json.encode(data.toJson());

class KelasKontrakModel {
    int code;
    String errorMessage;
    Data data;
    ...
    factory KelasKontrakModel.fromJson(Map<String, dynamic> json) => KelasKontrakModel(
        code: json["code"],
