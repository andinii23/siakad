                ...
                return Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        "Jadwal Kontrak KRS : ${snapshot.data!.data.list.awalKrs} - ${snapshot.data!.data.list.akhirKrs}",
                                                                        ...
                                                                        SizedBox(
                                                                          ...
                                                                          child: ListView.builder(
                                                                              ...
                                                                              itemBuilder: (context, dsn) {
                                                                                if (snapshot.data!.data.list.listKrs[index].dosen[dsn].gelarDepan != null) {
                                                                                  return Center(
                                                                                    child: Text(
