  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          Expanded(
              child: FutureBuilder<DetailKelasModel>(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                snapshot
                                    .data!.data.list.matakuliah.kodeMatakuliah
                                    .toString(),
                                style: TextStyle(
                              ...
                              Text(
                                snapshot
                                    .data!.data.list.matakuliah.namaMatakuliah
                                    .toString(),
                                textAlign: TextAlign.start,
